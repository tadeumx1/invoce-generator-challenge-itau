...
class ProductTaxRateCalculatorTest {
  ...
  /**
   * Characterization of C-1 at the calculator level. Two consecutive calls on the SAME instance
   * accumulate into a single list. M2 will flip this assertion to assert {@code result2.size() ==
   * 1}. See docs/business-rules.md §6.1 / .specs/codebase/CONCERNS.md C-1.
   */
  @Test
