...
/**
 * SAFETY-18, SAFETY-19 — characterization of defect C-3 (missing-region freight = 0). See
 * docs/business-rules.md §6.3 and .specs/codebase/CONCERNS.md C-3.
 *
 * <p>M2 (F-DEFECTS-FUNCTIONAL) will replace these assertions with the corrected behavior — either
 * reject the request, or pass freight through unchanged. Decision pending.
 */
class MissingRegionFreightCharacterizationTest {
   ...
   * first element of the post-map stream is null. This characterizes the true defect. Reason:
   * discovered during Execute; spec.md and CONCERNS.md updated to match.
   */
  @Test
