...
**Status:** F-RESILIENCE + F-OBSERVABILITY + F-AWS + F-CICD complete (2026-05-23). Roadmap milestones M1, M2, M3 all closed.
...
**F-CICD — GitHub Actions AWS deploy pipeline (proposal-grade)** — COMPLETE (2026-05-23, `.github/workflows/deploy-aws.yml` 175 lines, three jobs, OIDC; YAML parses clean via `ruby -ryaml`; F-AWS Terraform gate stays green after the two new root outputs)
